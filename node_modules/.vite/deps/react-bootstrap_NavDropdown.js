...
function useDropdownMenu(options = {}) {
  const context = (0, import_react.useContext)(DropdownContext_default);
...
var $704cf1d3b684cc5c$var$SSRContext = import_react2.default.createContext($704cf1d3b684cc5c$var$defaultContext);
...
function useDropdownItem({
  ...
  const onSelectCtx = (0, import_react4.useContext)(SelectableContext_default);
...
function useRefWithUpdate() {
  ...
  const attachRef = (0, import_react5.useCallback)((element) => {
    ref.current = element;
    forceUpdate();
  }, [forceUpdate]);
...
function Dropdown({
  ...
  const lastSourceEvent = (0, import_react5.useRef)(null);
  const focusInDropdown = (0, import_react5.useRef)(false);
  const onSelectCtx = (0, import_react5.useContext)(SelectableContext_default);
  const toggle = (0, import_react5.useCallback)((nextShow, event, source = event == null ? void 0 : event.type) => {
    onToggle(nextShow, {
      originalEvent: event,
      source
    });
  ...
  useEventListener((0, import_react5.useCallback)(() => window2.document, [window2]), "keydown", (event) => {
...
function useWrappedRefWithWarning(ref, componentName) {
  if (false)
    return ref;
  const warningRef = (0, import_react6.useCallback)((refValue) => {
...
var DropdownMenu2 = React8.forwardRef(({
  bsPrefix,
  className,
  align,
  rootCloseEvent,
  ...
  let alignEnd = false;
  const isNavbar = (0, import_react7.useContext)(NavbarContext_default);
  const prefix = useBootstrapPrefix(bsPrefix, "dropdown-menu");
  const {
    align: contextAlign,
    drop,
    isRTL
  } = (0, import_react7.useContext)(DropdownContext_default2);
  align = align || contextAlign;
  const isInputGroup = (0, import_react7.useContext)(InputGroupContext_default);
  const alignClasses = [];
  if (align) {
...
var DropdownToggle2 = React9.forwardRef(({
  bsPrefix,
  split,
  className,
  childBsPrefix,
  ...
  const dropdownContext = (0, import_react8.useContext)(DropdownContext_default);
...
var Dropdown2 = React10.forwardRef((pProps, ref) => {
  const {
    bsPrefix,
    drop,
    show,
...
var NavDropdown = React11.forwardRef(({
  id,
  title,
  children,
  bsPrefix,
