import {
  Overlay_default
} from "./chunk-RUTFJEED.js";
import "./chunk-2W7MLACI.js";
import {
  useWillUnmount
} from "./chunk-FJGMBXNH.js";
import {
  safeFindDOMNode
} from "./chunk-J22ZK4ZK.js";
import "./chunk-2NHBBVH7.js";
import {
  require_warning
} from "./chunk-HW27AJUB.js";
import "./chunk-5RLHEDJE.js";
import {
  contains
...
function OverlayTrigger({
  ...
  const triggerNodeRef = (0, import_react2.useRef)(null);
  const mergedRef = useMergedRefs_default(triggerNodeRef, children.ref);
  const timeout = useTimeout();
  const hoverStateRef = (0, import_react2.useRef)("");
  ...
  const handleHide = (0, import_react2.useCallback)(() => {
    timeout.clear();
  ...
  const handleFocus = (0, import_react2.useCallback)((...args) => {
    handleShow();
    onFocus == null ? void 0 : onFocus(...args);
  }, [handleShow, onFocus]);
  const handleBlur = (0, import_react2.useCallback)((...args) => {
    handleHide();
    onBlur == null ? void 0 : onBlur(...args);
  }, [handleHide, onBlur]);
  const handleClick = (0, import_react2.useCallback)((...args) => {
    setShow(!show);
    onClick == null ? void 0 : onClick(...args);
  }, [onClick, setShow, show]);
  const handleMouseOver = (0, import_react2.useCallback)((...args) => {
    handleMouseOverOut(handleShow, args, "fromElement");
  }, [handleShow]);
  const handleMouseOut = (0, import_react2.useCallback)((...args) => {
  ...
  return (0, import_jsx_runtime3.jsxs)(import_jsx_runtime2.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react2.cloneElement)(children, triggerProps), (0, import_jsx_runtime.jsx)(Overlay_default, {
      ...props,
      show,
      onHide: handleHide,
      flip,
